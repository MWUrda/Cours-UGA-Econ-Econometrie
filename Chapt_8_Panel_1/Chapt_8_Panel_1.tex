...
\begin{itemize}
    ...
    \begin{align*}
    \underset{N\to + \infty}{\plim} \hat{\alpha}_i &= T^{-1}\sumtT\left(y_{it} - \boldx_{it}^\prime\left(\underset{\plim}{N\to +\infty} \hat{\bolda}_N^{WG}\right)\right) = T^{-1}\sumtT\left(y_{it}- \boldx_{it}^\prime\beta\right)\\
