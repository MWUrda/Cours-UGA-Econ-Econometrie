...
\centering
	...
	%\vspace{1cm}
	\vspace{0.5cm}
	{\Large\bfseries \textsc{Régression Linéaire, Endogénéité, et Variables Instrumentales (1)} \par}
    \vspace{1cm}   
...
\begin{align*}
	\Exp(Y|X)&=X^\tr\beta +\Exp(U|X) = X^\tr\beta.
\end{align*}
...
sous cette condition et en supposant que $\Exp(XX^\tr)$ soit de plein rang:
\begin{align}
\beta &=\left(\Exp(XX^\tr)\right)^{-1}\Exp(XY)
\label{eq5}
\end{align}
...
\begin{align}
	\beta^{MCO} &=\left(\sumiton X_iX_i^\tr)\right)^{-1}\sumiton X_iY_i,
	\label{eq6}
\end{align}
...
Dès lors \eqref{eq4} n'est pas vérifiée on parle d'endogénéité des régresseurs. Ceci ne signifie pas que 
 ...
 \begin{align}
	Y &= X_1^\tr\beta_1 + X_2^\tr\beta_2 + U =: X^\tr\beta + U, \ \Exp(X_1U) \neq 0, \ \Exp(X_2U) = 0.
	\label{eq7}
\end{align}
...
de régresseurs exogènes, $\beta_1$ et $\beta_2$ sont les vecteurs de paramètres qui leur sont associés. L'ensemble des régresseurs est 
 donc $X := (X_1^\tr, X_2^\tr) ^\tr$ et celui des paramètres $\beta := (\beta_1^\tr, \beta_2^\tr) ^\tr$, et 
...
\begin{align}
	Y &= X_{1i}^\tr\beta_1 + X_{2i}^\tr\beta_2 + U_i =: X_i^\tr\beta + U_i, \ \Exp(X_{1i}U_i) \neq 0, \ \Exp(X_{2i}U_i) = 0.
	\label{eq8}
 \end{align}
...
\begin{align*}
	...
	\end{align*}
	où $\boldY$ est le vecteur $(n\times 1)$ ayant pour élément $i$ $Y_i$, $\boldX_1$ est la matrice $(n\times K_1)$ de régresseurs endogènes ayant pour ligne $i$ $X_{1i}^\tr$, $\boldX_2$ est la matrice $(n\times K_2)$ de régresseurs exogènes ayant pour ligne $i$ $X_{2i}^\tr$, et $\boldU$ est le vecteur $(n\times 1)$ ayant pour élément $i$ $U_i$. L'estimateur des MCO de $\beta_1$ est,
	\begin{align*}
	\widehat{\beta}_{1n} &= (\boldX_1^\tr\boldM_2\boldX_1)^{-1}\boldX_1^\tr\boldM_2\boldY \\
	&=\beta_1 +(\boldX_1^\tr\boldM_2\boldX_1)^{-1}\boldX_1^\tr\boldM_2\boldU
	\end{align*}
	où $\boldM_2 = \Id_n - \boldX_2(\boldX_2^\tr\boldX_2)^{-1}\boldX_2^\tr$. Nous avons,
	\begin{align*}
	n^{-1}\boldX_1^\tr\boldM_2\boldX_1 &= n^{-1}\sumiton X_{1i}X_{1i}^\tr - n^{-1}\sumiton X_{1i}X_{2i}^\tr\left(n^{-1}\sumiton X_{2i}X_{2i}^\tr\right)^{-1} n^{-1}\sumiton X_{2i}X_{1i}^\tr\\
	n^{-1}\boldX_1^\tr\boldM_2\boldU &= n^{-1}\sumiton X_{1i}U_i - n^{-1}\sumiton X_{1i}X_{2i}^\tr\left(n^{-1}\sumiton X_{2i}X_{2i}^\tr\right)^{-1} n^{-1}\sumiton X_{2i}U_i^\tr
	\end{align*}
	Supposons que,
	\begin{enumerate}[label = (A.\arabic*)]
	\item Les observations $\{(Y_i, X_i)\}_{i=1}^n$ sont i.i.d.
	\item $\Exp(X_{ik}^2) < \infty$ pour tout $k=1,...,K$.
	\item $\Exp(X_iX_i^\tr)$ est définie positive.
	\item $\Exp(U_i^2) < \infty$.
	\end{enumerate}
	Par la loi faible des grands nombre,
	\begin{align*}
	n^{-1}\sumiton X_{1i}X_{1i}^\tr &\limp \Exp(X_{1i}X_{1i}^\tr)\\
	n^{-1}\sumiton X_{1i}X_{2i}^\tr &\limp \Exp(X_{1i}X_{2i}^\tr)\\
	n^{-1}\sumiton X_{2i}X_{2i}^\tr &\limp \Exp(X_{2i}X_{2i}^\tr)\\
	n^{-1}\sumiton X_{2i}U_i^\tr &\limp 0\\
	n^{-1}\sumiton X_{1i}U_i^\tr &\limp \Exp(X_{1i}U_i)
	\end{align*}
	Ainsi,
	\begin{align*}
	n^{-1}\boldX_1^\tr\boldM_2\boldX_1 &\limp \Exp(X_{1i}X_{1i}^\tr)-\Exp(X_{1i}X_{2i}^\tr)\left( \Exp(X_{2i}X_{2i}^\tr)\right)^{-1}\Exp(X_{2i}X_{1i}^\tr)\\
	n^{-1}\boldX_1^\tr\boldM_2\boldU &\limp \Exp(X_{1i}U_i) - \Exp(X_{1i}X_{2i}^\tr)\left( \Exp(X_{2i}X_{2i}^\tr)\right)^{-1}\Exp(X_{2i}U_i)\\
	&=\Exp(X_{1i}U_i) \\
	&\neq 0
	\end{align*}
	et nous concluons que $\hat{\beta}_{1n} $ n'est pas convergent,
	\begin{align*}
	\hat{\beta}_{1n} &\limp \beta_1 + \left(\Exp(X_{1i}X_{1i}^\tr)-\Exp(X_{1i}X_{2i}^\tr)\left( \Exp(X_{2i}X_{2i}^\tr)\right)^{-1}\Exp(X_{2i}X_{1i}^\tr)\right)^{-1}\Exp(X_{1i}U_i)\\
	&\neq \beta_1
	\end{align*}
	La non convergence de l'estimateur des MCO de $\beta_2$ peut être montré de manière similaire. Nous avons,
	\begin{align*}
	\hat{\beta}_{2n} = \beta_2 + (\boldX_2^\tr\boldM_1\boldX_2)^{-1}\boldX_2^\tr\boldM_1\boldU
	\end{align*}
	où $\boldM_1 = \Id_n - \boldX_1(\boldX_1^\tr\boldX_1)^{-1}\boldX_1^\tr$. Et nous avons,
	\begin{align*}
	\hat{\beta}_{2n}  &\limp \beta_2 + \left(\Exp(X_{2i}X_{2i}^\tr)-\Exp(X_{2i}X_{1i}^\tr)\left( \Exp(X_{1i}X_{1i}^\tr)\right)^{-1}\Exp(X_{1i}X_{2i}^\tr)\right)^{-1}\Exp(X_{2i}X_{1i}^\tr)\Exp(X_{1i}X_{1i}^\tr)^{-1}\Exp(X_{1i}U_i)\\
	&\neq \beta_2
	\end{align*}
...
\begin{align*}
Y_i = \tilde{X}_{i1}^\tr\beta + X_{i2}^\tr\beta_2 + V_i
\end{align*}
...
\begin{align*}
Y_i = X_{i1} ^\tr\beta + X_{i2}^\tr\beta_2 - \epsilon_i^\tr\beta + V_i
\end{align*}
Posons $U_i = - \epsilon_i^\tr\beta + V_i$. Alors que $ X_{i2}$ est exogène, $X_{i1}$ est endogène car  corrélé avec $U_i$ par le biais de $\epsilon_i$.
\subsubsection*{Simultanéité}
Considérons l'équation suivante,
\begin{align*}
Heures_i = \beta_1Enfants_i + X_{i2}^\tr\beta_2 + U_i
\end{align*}
...
\begin{align*}
Enfants_i = \gamma_1 Heures_i + Z_{i1}^\tr\gamma_2+ + V_i
\end{align*}
...
\begin{align*}
Enfants_i  = X_{i2}^\tr\left(\frac{\beta_2\gamma_1}{1-\beta_1\gamma_1}\right) + Z_{i1}^\tr \left(\frac{\gamma_2}{1-\beta_1\gamma_1}\right) + \left(\frac{\gamma_1}{1-\beta_1\gamma_1}\right)U_i + \left(\frac{1}{1-\beta_1\gamma_1}\right)V_i
\end{align*}
...
avec $Z_i:=(Z_{1i}\tr, X_{2i}^\tr)^\tr$ qui est un vecteur de $K_1 + K_2 = K$ variables exogènes.
...
\begin{align}
	\Rang\left(\Exp(Z_iX_i^\tr)\right) &= K
	\label{eq10}
\end{align}
...
Elle échouera si, par exemple, $\Exp(Z_{1i}X_i^\tr) = 0$($Z_{1i}$ est exogène mais c'est un bruit aléatoire). 
...
et que pour chaque variables endogène nous avons une variables exogène(une VI) qui est 
 exclue du modèle $Y_i = X_i^\tr\beta +U_i$. Lorsque tous les régresseurs sont endogènes 
...
\begin{align*}
n^{-1}\sumiton Z_i\left(Y_i-X_i^\tr\hat{\beta}^{VI}_n\right) = 0
\end{align*}
d'où,
\begin{align*}
\hat{\beta}^{VI}_n &= \left(\sumiton Z_iX_i^\tr\right)^{-1}\sumiton Z_iY_i\\
&=(\boldZ^\tr\boldX)^{-1}\boldZ^\tr\boldY
\end{align*}
où $\boldX$ est la matrice $(n\times K)$ ayant pour élément $i$ $X_i^\tr$, et $\boldZ$ est la matrice $(n\times K)$ ayant pour élément $i$ $Z_i^\tr$.\\
...
\item $Y_i = X_i^\tr\beta + U_i$.
\item $\Exp(Z_iU_i) = 0$.
\item $\Rang\left(\Exp(Z_iX_i^\tr)\right) = K$.
\item $\Exp(X_{ik}^2) < \infty$ pour tout $k=1,...,K$.
\item $\Exp(Z_{1ik}^2) < \infty$ pour tout $k=1,...,K_1$.
\item $\Exp(U_i^2Z_iZ_i^\tr)$ est définie positive.
\end{enumerate}
\label{cond1}
\end{condition}
...
\'Ecrivons,
\begin{align}
\hat{\beta}^{VI}_n = \beta + \left(n^{-1}\sumiton Z_iX_i^\tr\right)^{-1}n^{-1}\sumiton Z_iU_i
\label{eq3}
\end{align}
...
\begin{align*}
\hat{\beta}^{VI}_n  &\limp \beta + \Exp(Z_iX_i^\tr)^{-1}\Exp(Z_iU_i)\\
&= \beta
\end{align*}
\end{proof}
...
\begin{align*}
	n^{1/2}(\hat{\beta}^{VI}_n - \beta ) &\limd (\Exp(Z_iX_i^\tr))^{-1}\mathcal{N}\left(0,\Exp(U_i^2Z_iZ_i^\tr)\right)\\
&=\mathcal{N}\left(0,  \Vr\right)
\end{align*}
où 
\begin{align*}
\Vr &= (\Exp(Z_iX_i^\tr))^{-1}\Exp(U_i^2Z_iZ_i^\tr) (\Exp(X_iZ_i^\tr))^{-1}
\end{align*}
	\label{pr2}
\end{propriete}
...
\begin{align*}
n^{1/2}(\hat{\beta}_n^{VI} - \beta ) = \left(n^{-1}\sumiton Z_iX_i^\tr\right)^{-1}n^{-1/2} \sumiton Z_iU_i
\end{align*}
...
\begin{align*}
n^{1/2}(\hat{\beta}_n^{VI} - \beta ) &\limd (\Exp(Z_iX_i^\tr))^{-1}\mathcal{N}\left(0,\Exp(U_i^2Z_iZ_i^\tr)\right)\\
&=\mathcal{N}\left(0,  (\Exp(Z_iX_i^\tr))^{-1}\Exp(U_i^2Z_iZ_i^\tr) (\Exp(X_iZ_i^\tr))^{-1}\right)
\end{align*}
\end{proof}
...
\begin{align*}
\left(n^{-1}\sumiton Z_iX_i^\tr\right)^{-1} n^{-1} \sumiton (\hat{U}_i^2Z_iZ_i^\tr) \left(n^{-1}\sumiton X_iZ_i^\tr\right)^{-1}
\end{align*}
où $\hat{U}_i = Y_i - X_i^\tr\hat{\beta}_n^{VI}$.
